...
public class User extends ParseUser {
    ...
    public void setDisplayName(String displayName) { put("displayName", displayName); }

    public ParseFile getProfilePicture() {
        return getParseFile("profilePicture");
    }
    public void setProfilePicture(ParseFile profilePicture) { put("profilePicture", profilePicture); }
    ...
    public static boolean someoneIsLoggedInAndMemberOfAHousehold() { return (getCurrentUser() != null && getCurrentUser().getActiveHousehold() != null); }
