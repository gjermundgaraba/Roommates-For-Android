...
public class AcceptInvitationOnClickListener implements View.OnClickListener {
    WithoutHouseholdActivity activity;
    Context context;
    ...
    private void acceptInvitation() {
        ...
        if (selectedInvitation != null) {
            ...
            ProgressDialog acceptInvitationProgress = ProgressDialog.show(context,
                    activity.getString(R.string.progressdialog_title_accepting_invitation),
                    activity.getString(R.string.progressdialog_message_accepting_invitation),
                    true);
            ParseCloud.callFunctionInBackground("acceptInvitation", params, new AcceptInviteCallBack<Object>(acceptInvitationProgress));
        }
    }
